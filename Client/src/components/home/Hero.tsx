          ...
          <div className="animate-fade-in-up text-center lg:text-left">
            ...
            <div className="mt-12 grid grid-cols-3 gap-4 border-t border-border/50 pt-8">
              <div className="text-center lg:text-left">
                ...
                <p className="text-sm text-muted-foreground">Gönüllü Terapist</p>
              </div>
              <div className="text-center lg:text-left">
                <p className="text-2xl font-bold text-foreground md:text-3xl">10K+</p>
                <p className="text-sm text-muted-foreground">Danışan</p>
              </div>
              <div className="text-center lg:text-left">
                <p className="text-2xl font-bold text-foreground md:text-3xl">25K+</p>
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="absolute -left-4 top-1/4 animate-float rounded-xl bg-card p-4 shadow-medium delay-100">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-accent">
                    <Shield className="h-5 w-5 text-accent-foreground" aria-hidden="true" />
                  </div>
                  <div>
                    <p className="text-sm font-medium text-foreground">%100 Gizli</p>
              ...
              <div className="absolute -right-4 bottom-1/4 animate-float rounded-xl bg-card p-4 shadow-medium delay-300">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">Uzman Kadro</p>
